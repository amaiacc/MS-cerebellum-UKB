...
#------------------------------------ 
# define phenotypes
p2=WR_RT_combined_STERR_GCOFF
p3=WR_Z_combined_STERR_GCOFF
...
if [ ! -f ${working_dir}/${name}_rg.log ]
 ...
 then
   ...
   ldsc.py \
   --rg ${p1}.sumstats.gz,${gwas_dir}${p2}.sumstats.gz,${gwas_dir}${p3}.sumstats.gz \
