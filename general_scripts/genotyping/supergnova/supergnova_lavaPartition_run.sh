...
supergnova_dir2=/export/home/acarrion/acarrion/projects/general_scripts/genotyping/supergnova/partition/
...
--partition ${supergnova_dir2}/lava_chr@.bed \
--out ${out}
